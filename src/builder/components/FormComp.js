...
export const TextForm = ({ handleChange, style = {}, state, ...props }) => {
  ...
  return (
    <View style={style}>
      <TextInput
        mode="flat"
        onChangeText={(value) => handleChange({ value, ...props })}
        {...props}
        value={value}
      />
    </View>
...
export const TextareaForm = ({ handleChange, ...props }) => (
  <TextForm handleChange={handleChange} {...props} multiline />
);
...
export const FormSwitch = ({ handleChange, state, ...props }) => {
  ...
  return (
    <Switch
      {...props}
      onValueChange={() => handleChange({ ...props, value: !value })}
      value={value}
    />
  );
};
...
export const FormIconButton = ({ style = {}, ...args }) => {
  return (
    <View style={style}>
      <IconButton icon="check-circle" {...args} />
    </View>
  );
};
...
export const FormSubmit = ({
  ...
  return (
    <Button
      ...
      onPress={
        isSubmitting ? () => console.log("isSubmitting") : () => handleSubmit()
      }
      {...args}
    >
      {label}
        ...
        return (
          <Field>
            <List.Item
              ...
              description={value}
              left={() => (
                <IconButton color={value} size={30} icon="brightness-1" />
              )}
            />
